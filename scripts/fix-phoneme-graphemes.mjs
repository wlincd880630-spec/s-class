...
const OVERRIDES = {
  ...
  colorful: [{ letter: 'c', symbol: '/k/' }, { letter: 'o', symbol: '/ʌ/' }, { letter: 'l', symbol: '/l/' }, { letter: 'or', symbol: '/ə/' }, { letter: 'f', symbol: '/f/' }, { letter: 'u', symbol: '/ʊ/' }, { letter: 'l', symbol: '/l/' }],
  color: [{ letter: 'c', symbol: '/k/' }, { letter: 'o', symbol: '/ʌ/' }, { letter: 'l', symbol: '/l/' }, { letter: 'or', symbol: '/ə/' }],
  'Mister（Mr.）': [{ letter: 'M', symbol: '/m/' }, { letter: 'i', symbol: '/ɪ/' }, { letter: 'st', symbol: '/s/' }, { letter: 'er（Mr.）', symbol: '/ə/' }],
  Taiji: [{ letter: 'T', symbol: '/t/' }, { letter: 'ai', symbol: '/aɪ/' }, { letter: 'j', symbol: '/dʒ/' }, { letter: 'i', symbol: '/iː/' }],
  math: [{ letter: 'm', symbol: '/m/' }, { letter: 'a', symbol: '/æ/' }, { letter: 'th', symbol: '/θ/' }],
  'police officer': [
    { letter: 'p', symbol: '/p/' }, { letter: 'o', symbol: '/ə/' }, { letter: 'l', symbol: '/l/' }, { letter: 'i', symbol: '/iː/' }, { letter: 'ce', symbol: '/s/' },
    { letter: ' ', symbol: '—' },
    { letter: 'o', symbol: '/ɒ/' }, { letter: 'ff', symbol: '/f/' }, { letter: 'i', symbol: '/ɪ/' }, { letter: 'c', symbol: '/s/' }, { letter: 'er', symbol: '/ə/' },
  ],
