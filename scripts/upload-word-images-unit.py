# -*- coding: utf-8 -*-
"""移动配图、上传 COS、更新 data.js — 用法: python upload-word-images-unit.py 5GA unit3"""
import json
import re
import shutil
import sys
...
grade = sys.argv[1] if len(sys.argv) > 1 else "5GA"
unit_id = sys.argv[2] if len(sys.argv) > 2 else "unit3"
