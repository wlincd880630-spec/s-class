/**
 * Dive, dolphin! · 本地 MP3 + Azure 英音男声（en-GB-RyanNeural）
 */
(function (global) {
  "use strict";
  ...
  global.LocalAudio.createApi("DiveDolphinTTS");
  if (global.DiveDolphinTTS) {
    enhance(global.DiveDolphinTTS);
  }

  global.DiveDolphinAzureTTS = { speak: azureSpeak, AZURE: AZURE, enhance: enhance };
