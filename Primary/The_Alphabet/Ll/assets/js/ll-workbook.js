/**
 * Ll 互动练习册：描红、圈 /l/ 图、狮子连线。
 */
(function () {
  "use strict";
  var L = window.LL_LESSON;
  var step = 1;
  var titles = ["", "练习册 A · 描红", "练习册 B · 圈图", "练习册 C · 连线"];
  ...
  var ctxA = bindTrace("L", "cap");
  var ctxa = bindTrace("l", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！lion、leaf、leg、lamp 都是 /l/。" : "再看看：只圈 /l/ 开头的图。";
