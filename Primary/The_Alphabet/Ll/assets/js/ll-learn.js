(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "L" }, { type: "trace", letter: "l" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="lazy lion"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Ll</div></div>' +
        "</div>" +
        "<h2>lazy lion</h2>" +
