(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "U" }, { type: "trace", letter: "u" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="unhappy umbrella"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Uu</div></div>' +
        "</div>" +
        "<h2>unhappy umbrella</h2>" +
