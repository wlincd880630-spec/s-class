(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "B" }, { type: "trace", letter: "b" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="big bear"></div>' +
          '<div class="meet-card bb-mark"><div class="big">Bb</div></div>' +
        "</div>" +
        "<h2>big bear</h2>" +
