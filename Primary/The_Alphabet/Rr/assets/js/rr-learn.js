(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "N" }, { type: "trace", letter: "n" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="racing rabbit"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Rr</div></div>' +
        "</div>" +
        "<h2>racing rabbit</h2>" +
