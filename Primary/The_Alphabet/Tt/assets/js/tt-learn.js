(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "T" }, { type: "trace", letter: "t" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="tall turtle"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Tt</div></div>' +
        "</div>" +
        "<h2>tall turtle</h2>" +
