(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "K" }, { type: "trace", letter: "k" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="kicking kangaroo"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Kk</div></div>' +
        "</div>" +
        "<h2>kicking kangaroo</h2>" +
