(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "E" }, { type: "trace", letter: "e" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="energetic egg"></div>' +
          '<div class="meet-card ee-mark"><div class="big">Ee</div></div>' +
        "</div>" +
        "<h2>energetic egg</h2>" +
