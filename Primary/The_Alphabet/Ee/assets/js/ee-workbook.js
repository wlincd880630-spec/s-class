...
(function () {
  ...
  var ctxA = bindTrace("E", "cap");
  var ctxa = bindTrace("e", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！egg、elbow、envelope、elephant 都是 /e/。" : "再看看：只圈 /e/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 E 和 e 涂色。" : "只涂 E 和 e，其它字母不要涂。";
