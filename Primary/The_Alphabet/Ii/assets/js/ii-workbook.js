...
(function () {
  ...
  var ctxA = bindTrace("I", "cap");
  var ctxa = bindTrace("i", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！insect、ink、igloo、iguana 都是 /ɪ/。" : "再看看：只圈 /ɪ/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    var picked = {};
    board.innerHTML = (L.iglooColorLetters || L.workbookLetters).map(function (ch, i) {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 I 和 i 涂色。" : "只涂 I 和 i，其它字母不要涂。";
