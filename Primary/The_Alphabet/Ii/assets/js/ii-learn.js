(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "I" }, { type: "trace", letter: "i" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="interesting insect"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Ii</div></div>' +
        "</div>" +
        "<h2>interesting insect</h2>" +
