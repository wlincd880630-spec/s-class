(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "C" }, { type: "trace", letter: "c" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="cool cat"></div>' +
          '<div class="meet-card cc-mark"><div class="big">Cc</div></div>' +
        "</div>" +
        "<h2>cool cat</h2>" +
