...
(function () {
  ...
  var ctxA = bindTrace("C", "cap");
  var ctxa = bindTrace("c", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！cat、cup、computer、car 都是 /k/。" : "再看看：只圈 /k/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 C 和 c 涂色。" : "只涂 C 和 c，其它字母不要涂。";
