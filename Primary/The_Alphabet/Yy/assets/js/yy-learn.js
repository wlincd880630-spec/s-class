(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "Y" }, { type: "trace", letter: "y" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="yellow yo-yo"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Yy</div></div>' +
        "</div>" +
        "<h2>yellow yo-yo</h2>" +
