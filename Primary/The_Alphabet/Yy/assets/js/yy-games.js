(function () {
  ...
  function startG5() {
    var n = 0;
    var items = L.track05Items || L.track05Items;
    var answered = false;
    function ask() {
      answered = false;
      var it = items[n];
      ...
      $("play-board").innerHTML =
        '<div class="play-stage">' +
          ...
          '<div class="big-choice" id="g5-choice">' +
            '<button type="button" class="btn btn-leaf" data-bb="1">Yy</button>' +
      ...
      $("g5-choice").onclick = function (e) {
        ...
        if (!b) return;
        var chooseYy = b.getAttribute("data-bb") === "1";
        if (chooseYy !== it.writeYy) {
          fb("再听开头音", false);
          play();
          return;
        }
  ...
  function startG6() {
    ...
    function check() {
      ...
      if (ok) {
        addScore(4);
        fb("顺序对了", true);
        showResult("完成", "yo-yo, yak, yogurt, yacht", startG6);
      } else {
        fb("再听，按歌曲顺序排", false);
      }
    }
