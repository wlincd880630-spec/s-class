...
(function () {
  ...
  var ctxA = bindTrace("H", "cap");
  var ctxa = bindTrace("h", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！hat、horse、house、hot dog 都是 /h/。" : "再看看：只圈 /h/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    var picked = {};
    board.innerHTML = (L.houseColorLetters || L.workbookLetters).map(function (ch, i) {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 H 和 h 涂色。" : "只涂 H 和 h，其它字母不要涂。";
