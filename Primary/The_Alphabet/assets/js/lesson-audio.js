 ...
 * 自动读取 window.AA_LESSON、BB_LESSON、CC_LESSON、DD_LESSON、EE_LESSON、FF_LESSON、GG_LESSON、HH_LESSON、II_LESSON、MM_LESSON、NN_LESSON、ABC_REVIEW、DEF_REVIEW、MNO_REVIEW、ABCDEF_REVIEW。
 */
(function (global) {
  "use strict";
  ...
  function lesson() {
    return global.AA_LESSON || global.BB_LESSON || global.CC_LESSON || global.DD_LESSON || global.EE_LESSON || global.FF_LESSON || global.GG_LESSON || global.HH_LESSON || global.II_LESSON || global.MM_LESSON || global.NN_LESSON || global.ABC_REVIEW || global.DEF_REVIEW || global.MNO_REVIEW || global.ABCDEF_REVIEW || null;
  }
