 ...
 * 自动读取 window.AA_LESSON、BB_LESSON、CC_LESSON、DD_LESSON、EE_LESSON、FF_LESSON、GG_LESSON、HH_LESSON、II_LESSON、JJ_LESSON、KK_LESSON、LL_LESSON、WW_LESSON、XX_LESSON、ABC_REVIEW、DEF_REVIEW、GHI_REVIEW、JKL_REVIEW、ABCDEF_REVIEW、GHIJKL_REVIEW。
 */
(function (global) {
  "use strict";
