(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "S" }, { type: "trace", letter: "s" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="super seal"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Ss</div></div>' +
        "</div>" +
        "<h2>super seal</h2>" +
