(function () {
  ...
  function startG5() {
    var n = 0;
    var items = L.monkeyListenItems || L.track05Items;
    var answered = false;
    function ask() {
      answered = false;
      var it = items[n];
      ...
      $("play-board").innerHTML =
        '<div class="play-stage">' +
          ...
          '<div class="big-choice" id="g5-choice">' +
            '<button type="button" class="btn btn-leaf" data-bb="1">Mm</button>' +
      ...
      $("g5-choice").onclick = function (e) {
        ...
        if (!b) return;
        var chooseMm = b.getAttribute("data-bb") === "1";
        if (chooseMm !== it.writeMm) {
          fb("再听开头音", false);
          play();
          return;
        }
  ...
  function startG6() {
    ...
    function check() {
      ...
      if (ok) {
        addScore(4);
        fb("顺序对了", true);
        showResult("完成", "mouse, money, milk, monkey", startG6);
      } else {
        fb("再听，按歌曲顺序排", false);
      }
    }
