(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "F" }, { type: "trace", letter: "f" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="good gorilla"></div>' +
          '<div class="meet-card gg-mark"><div class="big">Gg</div></div>' +
        "</div>" +
        "<h2>good gorilla</h2>" +
