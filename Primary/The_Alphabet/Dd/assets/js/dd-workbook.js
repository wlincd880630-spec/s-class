...
(function () {
  ...
  var ctxA = bindTrace("D", "cap");
  var ctxa = bindTrace("d", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！dog、desk、doll、duck 都是 /d/。" : "再看看：只圈 /d/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 D 和 d 涂色。" : "只涂 D 和 d，其它字母不要涂。";
