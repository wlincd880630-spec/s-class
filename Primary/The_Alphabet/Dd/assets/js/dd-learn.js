(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "D" }, { type: "trace", letter: "d" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="dizzy dog"></div>' +
          '<div class="meet-card dd-mark"><div class="big">Dd</div></div>' +
        "</div>" +
        "<h2>dizzy dog</h2>" +
