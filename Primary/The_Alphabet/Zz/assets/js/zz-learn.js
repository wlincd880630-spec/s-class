(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "Z" }, { type: "trace", letter: "z" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="zany zebra"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Zz</div></div>' +
        "</div>" +
        "<h2>zany zebra</h2>" +
