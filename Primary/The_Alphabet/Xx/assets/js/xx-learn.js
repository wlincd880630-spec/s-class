(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "X" }, { type: "trace", letter: "w" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="fox in a box"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Xx</div></div>' +
        "</div>" +
        "<h2>fox in a box</h2>" +
