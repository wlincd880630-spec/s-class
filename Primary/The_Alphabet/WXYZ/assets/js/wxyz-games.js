(function () {
  ...
  function game2() {
    ...
    function next() {
      ...
      $("play").innerHTML = '<p>听单词，点正确字母（' + (i + 1) + "/" + rows.length + "）</p>" +
        ...
        '<div class="letter-pick">' + ["W", "X", "Y", "Z"].map(function (ch) {
  ...
  function game4() {
    ...
    var answers = tm.pairs || { W: "wolf", X: "fox", Y: "yogurt", Z: "zebra" };
    ...
    $("play-fb").textContent = "W–wolf–w · X–fox–x · Y–yogurt–y · Z–zebra–z";
