(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "W" }, { type: "trace", letter: "w" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="wise wolf"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Ww</div></div>' +
        "</div>" +
        "<h2>wise wolf</h2>" +
