...
(function () {
  ...
  var ctxA = bindTrace("F", "cap");
  var ctxa = bindTrace("f", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！fish、fan、farm、fork 都是 /f/。" : "再看看：只圈 /f/ 开头的图。";
  ...
  function renderBalloons() {
    ...
    $("btn-check-c").addEventListener("click", function () {
      ...
      $("fb-c").textContent = ok ? "涂对了！只给 F 和 f 涂色。" : "只涂 F 和 f，其它字母不要涂。";
