(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "V" }, { type: "trace", letter: "v" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="violet van"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Vv</div></div>' +
        "</div>" +
        "<h2>violet van</h2>" +
