(function () {
  ...
  var slides = [{ type: "meet" }]
    ...
    .concat([{ type: "video" }, { type: "trace", letter: "J" }, { type: "trace", letter: "j" }]);
  ...
  function render() {
    ...
    if (s.type === "meet") {
      box.innerHTML =
        ...
        '<div class="meet-row">' +
          '<div class="meet-card"><img src="' + L.mascot.img + '" alt="jumbo jet"></div>' +
          '<div class="meet-card ff-mark"><div class="big">Jj</div></div>' +
        "</div>" +
        "<h2>jumbo jet</h2>" +
