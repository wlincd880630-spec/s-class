/**
 * Jj 互动练习册：描红、圈 /dʒ/ 图、J 形迷宫连线。
 */
(function () {
  "use strict";
  var L = window.JJ_LESSON;
  var step = 1;
  var titles = ["", "练习册 A · 描红", "练习册 B · 圈图", "练习册 C · 迷宫"];
  ...
  var ctxA = bindTrace("J", "cap");
  var ctxa = bindTrace("j", "small");
  ...
  function renderCircle() {
    ...
    $("btn-check-b").addEventListener("click", function () {
      ...
      $("fb-b").textContent = ok ? "全对！jet、jam、juice、jacket 都是 /dʒ/。" : "再看看：只圈 /dʒ/ 开头的图。";
