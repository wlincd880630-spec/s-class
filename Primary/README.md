...
按**语言难度**分册。双击打开对应级别目录，或从站点首页进入。

| 级别 | 入口 | 适合 | 课程 |
|------|------|------|------|
| **Level 1** | [index.html](index.html) | 一年级绘本 · 短句启蒙 | Play, Kitty! · Jump, Pup! · Peek, Otter! · Dive, dolphin! · Hello, penguins! · Helpers in Your Neighborhood |
...
月球、沙漠、爬行动物三课已从 Level 1 拆出，不再与一年级绘本混排。
...
- 无需安装服务器，保持文件夹结构完整即可使用
- 听写页需联网加载 Google Fonts（Fredoka / Patrick Hand）
- 发音为本地 MP3，可直接离线播放单词与课文
- 科学课课件通过 `fetch()` 加载 JSON，请用 HTTP 打开（不要用 `file://`）
