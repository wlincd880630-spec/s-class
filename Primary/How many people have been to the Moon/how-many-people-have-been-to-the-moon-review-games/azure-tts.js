/**
 * World's Largest Deserts? · 本地 MP3 + Azure 英音男声（en-GB-RyanNeural）
 */
(function (global) {
  "use strict";
  ...
  global.LocalAudio.createApi("WhatAreReptilesTTS");
  if (global.WhatAreReptilesTTS) {
    enhance(global.WhatAreReptilesTTS);
  }

  global.WhatAreReptilesAzureTTS = { speak: azureSpeak, AZURE: AZURE, enhance: enhance };
})(typeof window !== "undefined" ? window : this);

if (typeof window !== 'undefined' && window.WhatAreReptilesTTS) window.WorldsLargestDesertsTTS = window.WhatAreReptilesTTS;
