# -*- coding: utf-8 -*-
"""从教材数据生成 Courseware/5GB/assets/data/data.js（五年级下册）"""
import json
import os
import re
import sys
...
UNIT_META = {
    "Module 1": {"id": "module1", "title": "往昔生活", "en": "Life Long Ago"},
    "Module 2": {"id": "module2", "title": "学习英语", "en": "Learning English"},
    "Module 3": {"id": "module3", "title": "饮食习惯", "en": "Food Habits"},
    "Module 4": {"id": "module4", "title": "家庭图书馆", "en": "Home Library"},
    "Module 5": {"id": "module5", "title": "轻便购物", "en": "Shopping"},
    "Module 6": {"id": "module6", "title": "旅途方位", "en": "Travel Directions"},
    "Module 7": {"id": "module7", "title": "工作与时间", "en": "Work & Time"},
    "Module 8": {"id": "module8", "title": "制作风筝", "en": "Making Kites"},
    "Module 9": {"id": "module9", "title": "剧院笑料", "en": "Theatre Laughs"},
    "Module 10": {"id": "module10", "title": "出行准备", "en": "Getting Ready"},
}
...
def main():
    ...
    units, wid = [], 0
    for unit_name, words in UNITS_5XIA.items():
    ...
    data = {"book": {"id": "fltrp-g5x", "name": "外研版五年级下册", "grade": 5, "semester": "下"}, "units": units}
    js = "/**\n * 外研版小学英语五年级下册单词数据\n * 自动生成，请勿手动编辑\n */\nconst TEXTBOOK_DATA = "
