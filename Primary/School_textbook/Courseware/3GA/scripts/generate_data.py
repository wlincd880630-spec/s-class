# -*- coding: utf-8 -*-
"""从教材数据生成 Courseware/3GA/assets/data/data.js（三年级上册）"""
import json
import os
import re
import sys
...
UNIT_META = {
    "Welcome": {"id": "welcome", "title": "走进校园", "en": "Welcome to School"},
    "Unit 1": {"id": "unit1", "title": "交朋友", "en": "Let's Be Friends"},
    "Unit 2": {"id": "unit2", "title": "我的学习用品", "en": "My School Things"},
    "Unit 3": {"id": "unit3", "title": "多彩世界", "en": "Colourful World"},
    "Unit 4": {"id": "unit4", "title": "数字乐趣", "en": "Fun with Numbers"},
    "Unit 5": {"id": "unit5", "title": "一家人", "en": "We're Family"},
    "Unit 6": {"id": "unit6", "title": "甜蜜的家", "en": "My Sweet Home"},
}
...
def main():
    ...
    units = []
    wid = 0
    for unit_name, words in UNITS_3SHANG.items():
    ...
    data = {
        "book": {"id": "fltrp-g3s", "name": "外研版三年级上册", "grade": 3, "semester": "上"},
        "units": units,
    }
