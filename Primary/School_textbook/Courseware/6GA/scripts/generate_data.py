# -*- coding: utf-8 -*-
"""从教材数据生成 Courseware/6GA/assets/data/data.js（六年级上册）"""
import json
import os
import re
import sys
...
UNIT_META = {
    "Module 1": {"id": "module1", "title": "数字与地图", "en": "Numbers & Maps"},
    "Module 2": {"id": "module2", "title": "唐人街游记", "en": "Chinatown Trip"},
    "Module 3": {"id": "module3", "title": "集邮爱好", "en": "Stamp Hobby"},
    "Module 4": {"id": "module4", "title": "节日文化", "en": "Festivals"},
    "Module 5": {"id": "module5", "title": "笔友交流", "en": "Pen Friends"},
    "Module 6": {"id": "module6", "title": "世界饮食", "en": "World Food"},
    "Module 7": {"id": "module7", "title": "熊猫与蛇", "en": "Pandas & Snakes"},
    "Module 8": {"id": "module8", "title": "名胜古迹", "en": "Famous Places"},
    "Module 9": {"id": "module9", "title": "联合国参观", "en": "Visit the UN"},
    "Module 10": {"id": "module10", "title": "图书馆规则", "en": "Library Rules"},
}
...
def main():
    ...
    units, wid = [], 0
    for unit_name, words in UNITS_6SHANG.items():
        ...
        for word in words:
            ...
            unit_words.append({
                "id": f"w{wid}",
                "word": word,
                "chinese": vocab.get(word, vocab.get(normalize_word(word), EXTRA_MEANINGS.get(word, word))),
    ...
    data = {"book": {"id": "fltrp-g6s", "name": "外研版六年级上册", "grade": 6, "semester": "上"}, "units": units}
    js = "/**\n * 外研版小学英语六年级上册单词数据\n * 自动生成，请勿手动编辑\n */\nconst TEXTBOOK_DATA = "
