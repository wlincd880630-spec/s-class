/**
 * Flutter, butterfly! · 本地 MP3 + Azure 英音男声（en-GB-RyanNeural）
 */
(function (global) {
  "use strict";
  ...
  global.LocalAudio.createApi("FlutterButterflyTTS");
  if (global.FlutterButterflyTTS) {
    enhance(global.FlutterButterflyTTS);
  }

  global.FlutterButterflyAzureTTS = { speak: azureSpeak, AZURE: AZURE, enhance: enhance };
