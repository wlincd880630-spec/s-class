...
(function () {
  ...
  const ZOOM_IMG =
    "#l13-book .scene-frame img, #l11-book .scene-frame img, #app .scene-frame img, " +
    "#l13-book .comic-frame img, #l11-book .comic-frame img, #app .comic-frame img";
  ...
  function initLessonImageLightbox() {
    const root =
      document.getElementById("l13-book") ||
