...
(function (global) {
  ...
  global.VERB_PDF_DATA = [
    ...
    { b: "catch", p: "caught", pp: "caught", zh: "院子里「猫昨天抓到啥」；校园通知「是否已经找到违规停车者」。", s: "A: Why was the cat proud yesterday? B: It caught a mouse in the yard in the afternoon.", x: "A: Has the school found the person who parked in the wrong place? B: Yes, the guards have caught him on camera, and they have reminded him to move the bike." },
    ...
    { b: "hear", p: "heard", pp: "heard", zh: "「昨晚声响」听见没；春游「有没有听到任何消息」。", s: "A: Did you hear that strange noise last night? B: Yes, I heard it twice, but I did not know where it came from.", x: "A: When do we leave for the spring outing? B: I have heard nothing official yet, and the class monitor has not announced the time." },
