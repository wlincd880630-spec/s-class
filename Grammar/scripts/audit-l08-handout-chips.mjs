...
const html = fs.readFileSync(path.join(root, "lesson08-page10-handout.html"), "utf8");
const m = {};
const re = /"([^"]{2,300})":\s*"(assets\/[^"]+\.mp3)"/g;
for (const name of ["l08-handout-manifest.embed.js", "handout-tts-manifest.js"]) {
