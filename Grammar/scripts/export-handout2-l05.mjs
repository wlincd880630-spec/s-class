/**
 * 导出 L05 名词所有格与 There be · 课堂同步讲义 → handout2/
 */
...
const HTML = join(ROOT, "L05", "lesson05-handout-classroom-full.html");
const OUT_PDF = join(OUT_DIR, "L05-名词所有格与There-be-课堂同步讲义.pdf");
