...
(function (global) {
  ...
  const CONFIG_KEY = 'chicago_solar_courseware_config';
  const IMAGE_BASE = 'https://s-class-1403296481.cos.ap-chengdu.myqcloud.com/s-class/REFH/05/courseware/assets/images/';
  const COURSEWARE_WEB_BASE = 'https://s-class-1403296481.cos.ap-chengdu.myqcloud.com/s-class/REFH/05/courseware/';
  const ARTICLE_PAGE_URL = COURSEWARE_WEB_BASE + 'part2-reading.html';
  const QUIZ_PAGE_URL = 'https://www.s-class.top/REFH/05/courseware/part4-quiz.html';
  const QUIZ_KICKER = 'S-Class · REFH 05 · Vocabulary Quiz Packet';
  const QUIZ_ACCENT = '#2e7d32';
...
请返回JSON: {"score":0-100,"issues":"问题指出(中文)","standard":"标准翻译(中文)"}`;
  ...
  function renderNav(active) {
    ...
    return `<nav class="top-nav">
      <a class="brand" href="index.html">☀️ Chicago Solar · Green Jobs</a>
