...
(function (global) {
  ...
  const COURSEWARE_WEB_BASE = 'https://s-class-1403296481.cos.ap-chengdu.myqcloud.com/s-class/REFH/01/courseware/';
  const ARTICLE_PAGE_URL = COURSEWARE_WEB_BASE + 'part2-reading.html';
  const QUIZ_PAGE_URL = 'https://www.s-class.top/REFH/01/courseware/part4-quiz.html';
  const QUIZ_KICKER = 'S-Class · REFH 01 · Vocabulary Quiz Packet';
  const QUIZ_ACCENT = '#1a6b4a';
