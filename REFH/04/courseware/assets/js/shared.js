...
(function (global) {
  ...
  const COURSEWARE_WEB_BASE = 'https://s-class-1403296481.cos.ap-chengdu.myqcloud.com/s-class/REFH/04/courseware/';
  const ARTICLE_PAGE_URL = COURSEWARE_WEB_BASE + 'part2-reading.html';
  const QUIZ_PAGE_URL = 'https://www.s-class.top/REFH/04/courseware/part4-quiz.html';
  const QUIZ_KICKER = 'S-Class · REFH 04 · Vocabulary Quiz Packet';
